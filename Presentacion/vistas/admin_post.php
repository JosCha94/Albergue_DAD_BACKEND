...
if (isset($_POST['registro_post'])) {
    ...
    $errores = $consulta->Validar_post($post);
    if (count($errores) == 0) {
                    ...
                    <form action="" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="form-floating">
                                <textarea class="form-control" placeholder="Escribe el contenido del post aqui" id="post_descripcion" name="post_descripcion" style="height: 100px" maxlength="16000" required> <?php if (isset($descrip)) echo $descrip ?></textarea>
                ...
                <div id="product_form">
                    <form action="" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="form-floating">
                                <textarea class="form-control" placeholder="Escribe el contenido del post aqui" id="post_descripcion" name="post_descripcion" style="height: 100px" maxlength="16000" required> <?php if (isset($descrip)) { echo $descrip; } else { echo $postID['post_descripcion']; } ?></textarea>
                                <label for="post_descripcion">Escribe el contenido del post aqui</label>
                            </div>
                            <div class="col-md-12 text-dark mt-3">
                                <label class="txt_form">Estado </label>
                ...
                <form method="post" enctype="multipart/form-data">
                    <div class="col-12">
                        ...
                        <div class=" mt-3 d-flex justify-content-around">
                            ...
                            <button type="submit" class="btn btn-danger my-3" name="EliminarImgPost" onclick="return confirm('¿Quieres eliminar esta imagen?')" <?php echo ($postID['post_img_tipo'] == null) ? 'disabled' : ''; ?>>Eliminar</button>
                        </div>
