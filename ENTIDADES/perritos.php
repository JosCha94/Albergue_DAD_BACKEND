...
class updt_perrito
{
    ...
    public function __construct($perro_nombre, $perro_peso, $perro_tamano, $perro_nacimiento, $perro_sexo, $perro_actividad, $perro_descripcion, $perro_estado){
        $this->perro_nombre = $perro_nombre;
        $this->perro_peso = $perro_peso;
        $this->perro_tamano = $perro_tamano;
        $this->perro_nacimiento = $perro_nacimiento;
    ...
    public function setPerro_estado($perro_descripcion){
        return $this->perro_descripcion=$perro_descripcion;
    }
